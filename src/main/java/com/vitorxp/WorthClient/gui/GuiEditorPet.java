...
public class GuiEditorPet extends GuiScreen {
    ...
    public void initGui() {
        ...
        btnViewsPets = new GuiButton(2, centerX - 125, y, 250, 20,
                "§e[Pet] §7Visibilidade de Pet: " + getStatus(com.vitorxp.WorthClient.WorthClient.petDisplayViewOff));
        ...
        btnPetsAllRemove = new GuiButton(3, centerX - 125, y, 250, 20,
                "§e[Pet] §7Remover todos os Pets: " + getStatus(com.vitorxp.WorthClient.WorthClient.viewsPetAll));
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.id == 2) {
            com.vitorxp.WorthClient.WorthClient.petDisplayViewOff = !com.vitorxp.WorthClient.WorthClient.petDisplayViewOff;
            button.displayString = "§e[Pet] §7Visibilidade de Pet: " + getStatus(com.vitorxp.WorthClient.WorthClient.petDisplayViewOff);
        } else if (button.id == 3) {
            com.vitorxp.WorthClient.WorthClient.viewsPetAll = !com.vitorxp.WorthClient.WorthClient.viewsPetAll;
            button.displayString = "§e[Pet] §7Remover todos os Pets: " + getStatus(com.vitorxp.WorthClient.WorthClient.viewsPetAll);
