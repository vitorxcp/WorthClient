...
public class CommandMutanteAnnounce implements ICommand {

    @Override
    public String getCommandName() {
        return "mutanteannunce";
    }
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        String status = com.vitorxp.WorthClient.WorthClient.announceZealot ? "§aativado" : "§cdesativado";
        Minecraft.getMinecraft().thePlayer.addChatMessage(
                new ChatComponentText("§bZealotAlert §8➜ §eAnúncio de Mutante " + status + "§e!")
        );
    }
