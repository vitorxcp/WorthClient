...
public class PerfConfig {
    ...
    public static boolean autoMemoryClean = true;
    ...
    public static void load(File f) {
        ...
        entityCull = cfg.getBoolean("entityCull", "render", entityCull, "Ativa ou desativa o sistema de culling geral");
        ...
        autoMemoryClean = cfg.getBoolean("autoMemoryClean", "memory", autoMemoryClean, "Limpeza automática de memória RAM periódica");
        lightOptEnabled = cfg.getBoolean("lightOptEnabled", "light", lightOptEnabled, "Otimização de atualizações de luz");
        lightUpdatesPerTick = cfg.getInt("lightUpdatesPerTick", "light", lightUpdatesPerTick, 5, 100, "Máximo de updates de luz por tick");
        skipVoidLight = cfg.getBoolean("skipVoidLight", "light", skipVoidLight, "Ignora cálculo de luz no void");
