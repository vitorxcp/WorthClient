...
public class WindowUtils {
    ...
    public static void setIcon() throws IOException {
        ...
        icons.add(loadIcon("/assets/skyblockmodvx/icons/Logo_Worth_16x16.png"));
        icons.add(loadIcon("/assets/skyblockmodvx/icons/Logo_Worth_32x32.png"));
        icons.add(loadIcon("/assets/skyblockmodvx/icons/icon.png"));
        icons.add(loadIcon("/assets/skyblockmodvx/icons/Logo_Worth_128x128.png"));
