...
import com.vitorxp.SkyBlockModVX.gui.utils.CosmicParticle;
...
public class GuiCosmicSplashScreen extends GuiScreen {
    ...
    private static final ResourceLocation LOGO = new ResourceLocation("skyblockmodvx", "textures/gui/logo_splash.png");
